                ...
                <div class="panel-body">
                  <form action="" method="POST" role="form" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                          <label for="">Chọn danh mục sách</label>
                    ...
                    <!--*************-->
                      <div class="form-group">
                       ...
                       <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="" placeholder="Nhập giá sách" name="soluong">
                      </div>
                      <!--*************-->
                      <div class="form-group">
                          <label for="">Giá hiện tại</label>
                          <input type="text" class="form-control" id="" placeholder="Nhập giá sách" name="giacu">
                      </div>
